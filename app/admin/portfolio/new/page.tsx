...
const portfolioSchema = z.object({
  ...
  image: z.string().url("URL ảnh không hợp lệ").min(1, "URL ảnh là bắt buộc"),
  ...
  const onSubmit = async (data: PortfolioFormData) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        setError(result.error || "Có lỗi xảy ra khi tạo dự án")
      }
    } catch (error) {
      ...
      <div className="border-b">
        <div className="container px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Thêm dự án vào portfolio</p>
          </div>
      ...
      <div className="container px-4 py-8">
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>Điền thông tin để thêm dự án mới</CardDescription>
          </CardHeader>
          <CardContent>
